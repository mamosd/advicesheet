        ...
        <div id="tab-documents">
            ...
            array(
                  ...
                  'config'=>array(
                                  ...
                                  'request'=>array(
                                     'endpoint'=> $this->createUrl('admin/nqprmcontractordocument', array('contractorId' => $model->contractorId)),
    ...
    <div class="titleWrap">
        ...
        <ul>
            <li class="seperator">
                ...
                <a href="<?php echo $this->createUrl('admin/nqprmcontractors');?>">Cancel</a>
            </li>
        </ul>
...
//        maxDate: '7'
    ...
    $(".disableDocument").click(function(){
        ...
        $.post("<?php echo $this->createUrl("admin/nqprmdisabledocument") ?>",
            {id : $(this).attr('rel')},
            function(data){
                if (data.result == 'fail')
