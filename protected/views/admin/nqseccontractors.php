...
<div class="titleWrap">
    ...
    <ul>
        ...
        <li class="seperator">
            ...
            <a href="<?php echo $this->createUrl('admin/nqseccontractor');?>" id="lnkNew">Add New</a>
        </li>
    </ul>
</div>
...
<tbody>
    ...
    ?>
        <tr>
          ...
          <td>
              <a href="<?php echo $this->createUrl('admin/nqseccontractor', array('id'=>$c->ContractorId));?>">
    ...
    ?>
        <tr class="row1">
            <td colspan="4">
                <div class="infoBox">There are no contractors setup on the system, <a href="<?php echo $this->createUrl('admin/nqseccontractor');?>">add a new one now</a>.</div>
            </td>
        </tr>
    <?php
    endif;
