...
*/
	...
	public function actionNqseccontractors()
    {
        $model = new NqsecContractorForm();
        $model->getContractorList();
        $this->render('nqseccontractors', array('model' => $model));
    }

	public function actionNqseccontractor($id = NULL)
    {
        $model = new NqsecContractorForm();
        $docsModel = new NqsecContractorDocumentsForm();
       
        if (isset($_POST['NqsecContractorForm']))
        {
            $model->setAttributes($_POST['NqsecContractorForm'], false);
			...
			if($model->validate() && $model->save()) 
            {
                if ( isset( $_POST['save'] ) )
                {
                    ...
                    {
                        $insert_id = Yii::app()->db->getLastInsertID();
                        $this->redirect(array("admin/nqseccontractor", 'id'=>$insert_id));
                    }
                }
                else if ( isset( $_POST['saveandexit'] ) )
                {
                    $this->redirect(array('admin/nqseccontractor'));
                }
            }
        ...
        $this->render('nqseccontractor', array('model' => $model, 'docsModel' => $docsModel));
    }

	public function actionNqseccontractordocument($contractorId)
    {
        ...
        $chunksFolder = Yii::getPathOfAlias('webroot').'/_uploads/temp/chunks';
        $fileFolder = '/_uploads/contractors-nq/'.$contractorId;
	...
	public function actionNqsecdisabledocument()
    {
	...
	public function actionNqprmcontractors()
    {
        $model = new NqprmContractorForm();
        $model->getContractorList();
        $this->render('nqprmcontractors', array('model' => $model));
    }

	public function actionNqprmcontractor($id = NULL)
    {
        $model = new NqprmContractorForm();
        $docsModel = new FinanceContractorDocumentsForm();
       
        if (isset($_POST['NqprmContractorForm']))
        {
            $model->setAttributes($_POST['NqprmContractorForm'], false);
	    ...
	    if($model->validate() && $model->save()) 
            {
                if ( isset( $_POST['save'] ) )
                {
                    ...
                    {
                        $insert_id = Yii::app()->db->getLastInsertID();
                        $this->redirect(array("admin/nqprmcontractor", 'id'=>$insert_id));
                    }
                }
                else if ( isset( $_POST['saveandexit'] ) )
                {
                    $this->redirect(array('admin/nqprmcontractor'));
                }
            }
        ...
        $this->render('nqprmcontractor', array('model' => $model, 'docsModel' => $docsModel));
    }

	public function actionNqprmcontractordocument($contractorId)
    {
        //$chunksFolder=Yii::getPathOfAlias('webroot').'/_uploads/temp/chunks';
        //$finalFolder = Yii::getPathOfAlias('webroot').'/_uploads/contractors/'.$contractorId;
        $chunksFolder = Yii::getPathOfAlias('webroot').'/_uploads/temp/chunks';
	...
	public function actionNqprmdisabledocument()
    {
        $id = isset($_POST['id']) ? $_POST['id'] : NULL;
        $result = array(
            'result' => 'success'
