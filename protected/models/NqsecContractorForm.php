 ...
 * @author ramon
 */
class NqsecContractorForm extends CFormModel
{
    public $listData;
...
//    public $data;
    ...
    public function getContractorList()
    {
        ...
        $this->listData = NqContractorDetails::model()->findAll(
                array(
                    'condition' => 'Data="SECONDARY"',
                    'order' => 'FirstName ASC'
                ));
    }
    ...
    {
        $data = NqContractor::model()->findByPk($this->contractorId);
        $this->code = $data->Code;
    ...
    public function save()
    {
        ...
        {
            $c = NqContractor::model()->findByPk($this->contractorId);
        }
        $c->Code = $this->code;
    ...
    {
        $all = NqContractorType::model()->findAll(array('order'=>'Description ASC'));
        $result = array();
        foreach($all as $i)
    ...
    {
        $all = NqContractor::model()->findAll(array(
    ...
    {
        $child = NqContractor::model()->find(array(
    ...
    {
        $result = array('PRIMARY' => 'PRIMARY', 'SECONDARY'=>'SECONDARY', 'MAILROOM' => 'MAILROOM');
